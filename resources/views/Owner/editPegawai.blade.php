        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {!! Form::text('nama',$data->nama,array('placeholder' => 'Nama Pegawai','class' => 'form-control')) !!}
                    ...
                    {!! Form::text('alamat',$data->alamat,array('placeholder' => 'Alamat Pegawai','class' => 'form-control')) !!}
                    <strong>Nomor Telepon Pegawai :</strong>
                    {!! Form::text('no_telp',$data->no_telp,array('placeholder' => 'Nomor Telepon Pegawai','class' => 'form-control')) !!}
                    <strong>Gaji Pegawai :</strong>
                    {!! Form::text('gaji',$data->gaji,array('placeholder' => 'Gaji Pegawai','class' => 'form-control')) !!}
                    <strong>Username Pegawai :</strong>
                    {!! Form::text('username',$data->username,array('placeholder' => 'Username Pegawai','class' => 'form-control')) !!}
